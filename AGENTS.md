...
- if you happens to needs tool that are not available in the current dev env to work better, download them in a portable mode inside a project subfolder .agents_tools and use them, also track them in AGENTS_TOOLS.md for your convenience and future memory. es. ripgrep, osquery, xmake or others
