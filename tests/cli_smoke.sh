...
printf 'skipme\n' >"$local_repath_root/src/other/keep.txt"
run_hx "$local_repath_root/src" "$local_repath_root/out"
assert_file "$local_repath_root/out/nested/deep/payload.txt"
run_hx -repath "**/payload*" "$local_repath_root/src" "$local_repath_root/out"
assert_file "$local_repath_root/out/payload.txt"
[ ! -e "$local_repath_root/out/other/keep.txt" ] || fail "unexpected file: $local_repath_root/out/other/keep.txt"
