...
local_delpath_root="$tests_cache_dir/cli/local_delpath"
mkdir -p "$local_delpath_root/src/nested/deep" "$local_delpath_root/out"
printf 'rewrite\n' >"$local_delpath_root/src/nested/deep/payload.txt"
run_hx "$local_delpath_root/src" "$local_delpath_root/out"
assert_file "$local_delpath_root/out/nested/deep/payload.txt"
run_hx -delpath "**/payload*" "$local_delpath_root/src" "$local_delpath_root/out"
assert_file "$local_delpath_root/out/payload.txt"
